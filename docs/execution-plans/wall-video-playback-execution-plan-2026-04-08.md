...
Transformar o diagnostico de `wall-video-playback-current-state-2026-04-08.md` em um plano de execucao implementavel para tornar video um fluxo de primeira classe dentro do teḷo.
...
- `docs/execution-plans/telao-ao-vivo-execution-plan.md`
