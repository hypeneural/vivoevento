...
- o novo plano deve aproveitar essas superfÃ­cies, nao substitui-las.
...
- React deve usar `useDeferredValue` e `useTransition` nas superfÃ­cies quentes, sem desenhar a V1 em cima de Suspense para data fetching administrativo;
...
- jobs assÃ­ncronos para sync AWS e recomputacoes incrementais;
...
- UX publica avanÃ§ada por relacao;
...
â”‚   â””â”€â”€ api.php
â”œâ”€â”€ Providers/
â”‚   â””â”€â”€ EventPeopleServiceProvider.php
â””â”€â”€ README.md
```
...
- preencher ou reconciliar projeÃ§Ãµes tardias.
...
- entregar navegaÃ§Ã£o operacional por pessoa.
...
- sincronizar representatives com a AWS de forma barata, segura e observÃ¡vel.
...
- sync fica observÃ¡vel e retry-safe;
...
- [x] criar sync AWS assÃ­ncrono por job
...
- jobs de counters, review queue e sync continuam fora do hot path, com ack local antes da reconciliacao assÃ­ncrona.
...
- integracao do detalhe do evento com CTA `Organizar pessoas`, sem desviar a UX para superfÃ­cies tecnicas;
...
- usar projeÃ§Ã£o incremental por delta;
