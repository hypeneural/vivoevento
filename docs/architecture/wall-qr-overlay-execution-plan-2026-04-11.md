...
- `docs/architecture/event-universal-qr-editor-execution-plan-2026-04-11.md`
...
- reload do manager recompõe o overlay igual ao ultimo estado salvo
...
5. `ResetWallAction` recompõe default de `qr_overlay`.
...
8. reload do manager recompõe overlay salvo.
