...
export const routeImports = {
  ...
  publicEventInvitation: () => import('@/modules/event-invitations/PublicEventInvitationPage'),
  publicOrganizationInvitation: () => import('@/modules/team-invitations/PublicOrganizationInvitationPage'),
...
const adminPreloadMatchers: Array<{ pattern: RegExp; loaders: RouteLoader[] }> = [
  ...
  },
  {
    ...
    loaders: [
      ...
      routeImports.eventPeople,
      routeImports.eventOperationsRoom,
