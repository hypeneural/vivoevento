...
const NAV_CONFIG: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'wall', label: 'Wall', icon: Monitor, path: '/wall', permission: 'wall.view', module: 'wall' },
      { key: 'play', label: 'Play', icon: Gamepad2, path: '/play', permission: 'play.view', module: 'play' },
      { key: 'hub', label: 'Hub', icon: Globe, path: '/hub', permission: 'hub.view', module: 'hub' },
    ],
  },
  {
    label: 'Gestao',
    section: 'management',
    items: [
      { key: 'partners', label: 'Parceiros', icon: Users, path: '/partners', permission: 'partners.manage', module: 'partners' },
