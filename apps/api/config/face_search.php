...
return [
    ...
    'providers' => [
        ...
        'aws_rekognition' => [
            ...
            'connect_timeout' => (float) env('FACE_SEARCH_AWS_CONNECT_TIMEOUT', 3),
            'query_timeout' => (float) env('FACE_SEARCH_AWS_QUERY_TIMEOUT', 8),
            'index_timeout' => (float) env('FACE_SEARCH_AWS_INDEX_TIMEOUT', 15),
