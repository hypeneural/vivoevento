    ...
    private function buildOrganization($organization): ?array
    {
        ...
        return [
            ...
            'branding' => [
                ...
                'logo_url' => $this->publicUrl($organization->logo_path),
                'logo_dark_path' => $organization->logo_dark_path,
                'logo_dark_url' => $this->publicUrl($organization->logo_dark_path),
                'favicon_path' => $organization->favicon_path,
                'favicon_url' => $this->publicUrl($organization->favicon_path),
                'watermark_path' => $organization->watermark_path,
                'watermark_url' => $this->publicUrl($organization->watermark_path),
                'cover_path' => $organization->cover_path,
                'cover_url' => $this->publicUrl($organization->cover_path),
