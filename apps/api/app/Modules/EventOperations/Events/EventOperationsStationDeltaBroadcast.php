...
class EventOperationsStationDeltaBroadcast implements ShouldBroadcast, ShouldDispatchAfterCommit
{
    use Dispatchable;
    ...
    {
        return 'operations.station.delta';
    }

    public function broadcastWith(): array
    {
        return $this->basePayload() + [
            'station_delta' => $this->delta->station_delta,
        ];
    }

    public function broadcastWhen(): bool
    {
        return $this->delta->station_delta !== null;
    }
