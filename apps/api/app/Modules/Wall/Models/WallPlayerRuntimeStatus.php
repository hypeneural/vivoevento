...
class WallPlayerRuntimeStatus extends Model
{
    ...
    protected $casts = [
        ...
        'error_count' => 'integer',
        'stale_count' => 'integer',
        'transition_random_pick_count' => 'integer',
        'transition_fallback_count' => 'integer',
        'board_piece_count' => 'integer',
        'board_burst_count' => 'integer',
        'board_budget_downgrade_count' => 'integer',
        'decode_backlog_count' => 'integer',
        'board_reset_count' => 'integer',
