...
class WallDiagnosticsService
{
    ...
    public function recordHeartbeat(EventWallSetting $settings, array $payload): WallPlayerRuntimeStatus
    {
        ...
        $player->fill([
            ...
            'active_transition_effect' => $payload['active_transition_effect'] ?? null,
            'transition_mode' => $payload['transition_mode'] ?? null,
            'transition_random_pick_count' => (int) ($payload['transition_random_pick_count'] ?? 0),
            'transition_fallback_count' => (int) ($payload['transition_fallback_count'] ?? 0),
            'transition_last_fallback_reason' => $payload['transition_last_fallback_reason'] ?? null,
            ...
            'board_piece_count' => $payload['board_piece_count'] ?? null,
            'board_burst_count' => (int) ($payload['board_burst_count'] ?? 0),
            'board_budget_downgrade_count' => (int) ($payload['board_budget_downgrade_count'] ?? 0),
            'decode_backlog_count' => (int) ($payload['decode_backlog_count'] ?? 0),
            'board_reset_count' => (int) ($payload['board_reset_count'] ?? 0),
            'board_budget_downgrade_reason' => $payload['board_budget_downgrade_reason'] ?? null,
    ...
    public function playerPayload(WallPlayerRuntimeStatus $player): array
    {
        ...
        return [
            ...
            'active_transition_effect' => $player->active_transition_effect,
            'transition_mode' => $player->transition_mode,
            'transition_random_pick_count' => (int) ($player->transition_random_pick_count ?? 0),
            'transition_fallback_count' => (int) ($player->transition_fallback_count ?? 0),
            'transition_last_fallback_reason' => $player->transition_last_fallback_reason,
            ...
            'board_piece_count' => $player->board_piece_count !== null ? (int) $player->board_piece_count : null,
            'board_burst_count' => (int) ($player->board_burst_count ?? 0),
            'board_budget_downgrade_count' => (int) ($player->board_budget_downgrade_count ?? 0),
            'decode_backlog_count' => (int) ($player->decode_backlog_count ?? 0),
            'board_reset_count' => (int) ($player->board_reset_count ?? 0),
            'board_budget_downgrade_reason' => $player->board_budget_downgrade_reason,
