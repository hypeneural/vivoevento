...
class MediaReplyTestRunResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'safety_results' => $this->safety_results_json ?? [],
            'contextual_results' => $this->contextual_results_json ?? [],
            'final_summary' => $this->final_summary_json ?? [],
            'policy_snapshot' => $this->policy_snapshot_json ?? [],
            'policy_sources' => $this->policy_sources_json ?? [],
