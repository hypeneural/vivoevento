    ...
    public function build(Plan $plan, string $billingCycle = 'monthly'): array
    {
        ...
        return [
            ...
            'price' => [
                ...
                'gateway_plan_id' => $price->gateway_plan_id,
                'gateway_plan_payload_json' => $price->gateway_plan_payload_json,
                'billing_type' => $price->billing_type,
                'billing_day' => $price->billing_day,
                'trial_period_days' => $price->trial_period_days,
                'payment_methods_json' => $price->payment_methods_json,
