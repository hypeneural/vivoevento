        ...
        return array_merge(
            ...
            [
                ...
                'latest_safety_evaluation' => $this->whenLoaded('latestSafetyEvaluation', fn () => $this->latestSafetyEvaluation ? [
                    ...
                    'provider_categories' => $this->latestSafetyEvaluation->provider_categories_json ?? [],
                    'provider_category_scores' => $this->latestSafetyEvaluation->provider_category_scores_json ?? [],
                    ...
                    'normalized_text_context' => $this->latestSafetyEvaluation->normalized_text_context,
                    'normalized_text_context_mode' => $this->latestSafetyEvaluation->normalized_text_context_mode,
                    'policy_snapshot' => $this->latestSafetyEvaluation->policy_snapshot_json ?? [],
                    'policy_sources' => $this->latestSafetyEvaluation->policy_sources_json ?? [],
                ...
                'latest_vlm_evaluation' => $this->whenLoaded('latestVlmEvaluation', fn () => $this->latestVlmEvaluation ? [
                    ...
                    'reason_code' => $this->latestVlmEvaluation->reason_code,
                    'matched_policies' => $this->latestVlmEvaluation->matched_policies_json ?? [],
                    'matched_exceptions' => $this->latestVlmEvaluation->matched_exceptions_json ?? [],
                    'input_scope_used' => $this->latestVlmEvaluation->input_scope_used,
                    'input_types_considered' => $this->latestVlmEvaluation->input_types_considered_json ?? [],
                    'confidence_band' => $this->latestVlmEvaluation->confidence_band,
                    'publish_eligibility' => $this->latestVlmEvaluation->publish_eligibility,
                    ...
                    'normalized_text_context' => $this->latestVlmEvaluation->normalized_text_context,
                    'normalized_text_context_mode' => $this->latestVlmEvaluation->normalized_text_context_mode,
                    'prompt_context' => $this->latestVlmEvaluation->prompt_context_json ?? [],
                    'policy_snapshot' => $this->latestVlmEvaluation->policy_snapshot_json ?? [],
                    'policy_sources' => $this->latestVlmEvaluation->policy_sources_json ?? [],
